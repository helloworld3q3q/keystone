...
module.exports = {
    ...
    select: {
        ...
        borderColor: theme.input.border.default.default,
        borderBottomColor: darken(theme.input.border.default.default, 4),
        borderTopColor: lighten(theme.input.border.default.default, 4),
